    ...
    public String getSubcategory_id ()
{
    ...
    {
        return "ClassPojo [online_event = "+online_event+", locale = "+locale+", organizer_id = "+organizer_id+", is_locked = "+is_locked+", currency = "+currency+", changed = "+changed+", id = "+id+", is_series_parent = "+is_series_parent+", created = "+created+", description = "+description+", name = "+name+", capacity = "+capacity+", venue_id = "+venue_id+", end = "+end+", is_series = "+is_series+", subcategory_id = "+subcategory_id+", listed = "+listed+", logo = "+logo+", shareable = "+shareable+", status = "+status+", category_id = "+category_id+", series_id = "+series_id+", url = "+url+", logo_id = "+logo_id+", start = "+start+", resource_uri = "+resource_uri+", format_id = "+format_id+", tx_time_limit = "+tx_time_limit+", hide_start_date = "+hide_start_date+", privacy_setting = "+privacy_setting+"]";
    }
}